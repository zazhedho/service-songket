...
func (r *GenericRepository[T]) ExistsByField(field string, value interface{}) (bool, error) {
	var count int64
...
func (r *GenericRepository[T]) ExistsByFields(filters map[string]interface{}) (bool, error) {
