    ...
    <div className="order-shell">
      <div className="header order-header">
        <div className="order-heading">
          <div className="order-eyebrow">Order Entry</div>
          <div className="order-title">{isEdit ? 'Edit Order' : 'Create Order'}</div>
          <div className="order-subtitle">Capture dealer, consumer, credit, and finance decision data in one flow.</div>
        </div>
          ...
          <div className="card form-section order-form-section">
            ...
            <div className="form-section-grid">
              ...
              {form.result_status === 'reject' && !showAttempt2 && poolingRowsCount >= 2 && (
                <div className="form-field-span-full order-form-help-panel">
              ...
              {showAttempt2 && (
                <>
                  <div className="form-field-span-full form-subsection-head order-attempt-subsection-head">
                    <div className="order-attempt-subsection-title">Finance Attempt 2</div>
